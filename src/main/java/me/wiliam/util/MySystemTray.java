 ...
 * @author：wiliam<br>
 * @date：2020/06/27 <br>
 * 参考：https://blog.csdn.net/why_su/article/details/90703123
 */
public class MySystemTray {
    ...
    static{
        ...
        showItem = new MenuItem("open打开");
        //菜单项(退出)
        exitItem = new MenuItem("exit退出");
        //此处不能选择ico格式的图片,要使用16*16的png格式的图片
        URL url = MySystemTray.class.getResource("/static/images/logo.png");
